import { Wav, WavRiffHeader, WavDataSubChunk, WavFmtSubChunk } from "../formats/wav"
...
export class WavExtractor {
    ...
    private extractorWavDataSubChunk(bitsPerSample: number): WavDataSubChunk {
        ...
        if (bitsPerSample === 8) {
            ...
            result.data16 = DataViewUtils.getBinaryData16(this.dataView, this.seekIndex, result.subChunk2Size);
        }
